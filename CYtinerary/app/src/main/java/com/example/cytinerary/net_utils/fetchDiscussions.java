...
import static com.example.cytinerary.net_utils.Const.URL_DISCUSSION;
 ...
 */
public class fetchDiscussions extends AsyncTask<Void, Void, Void> {

    private String discussions = "";
    private static ArrayList<Discussions.Discussion> discussions_a_list;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL(URL_DISCUSSION);
            ...
            while(line != null) {
                ...
                discussions = discussions + line;
            }

            JSONArray JA = new JSONArray(discussions);
            discussions_a_list = new ArrayList<>();
                ...
                if (JO.get("coursecode") != JSONObject.NULL) {
                    ...
                    if (JO.get("coursecode").equals(cc)) {
                        ...
                        if (JO.get("discussiontitle") != JSONObject.NULL &&
                            ...
                            // Check if this discussion post is a reply, if so we want to filter it out from the list
                            if (!(JO.get("discussiontitle").toString().startsWith("RE: "))) {

                                // This is a JO that we want, add it to the ArrayList
                                Discussions.Discussion discussion = new Discussions.Discussion(JO);
                                discussions_a_list.add(discussion);
                            }
                        }
                    }
                }
            ...
            adapter = new Discussions.DiscussionAdapter(AppController.getContext(),discussions_a_list);
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Discussions.discussions_list.setAdapter(adapter);
    }
